...
//   return (
//     <header className="sticky w-full top-0 left-0 right-0 bg-white shadow-md z-50">
...
//       {/* Mobile Menu */}
//       {menuOpen && (
//         <nav className="md:hidden bg-white border-t shadow-md flex flex-col p=4">
//           {generateMenu()}
//         </nav>
//       )}
//     </header>
...
export default function Navbar() {
  ...
  return (
    <header className="sticky border-b border-gray-200 top-0 bg-white z-50">
      ...
      {/* Mobile Menu */}
      {menuOpen && (
        <nav className="md:hidden bg-white border-t border-gray-200 shadow-md flex flex-col items-center">
          {generateMenu()}
        </nav>
      )}
    </header>
